...
void OnInit(){
	...
	Scaling=TerminalInfoInteger(TERMINAL_SCREEN_DPI)/96;
...
void DrawLabel(string myName,string myText,string myFont,int myFontSize,color myColor,int myX,int myY){
	...
	ObjectSetInteger(ChartIDLong,myName,OBJPROP_XDISTANCE,myX);
	ObjectSetInteger(ChartIDLong,myName,OBJPROP_YDISTANCE,myY);
